    ...
    return (
      <div className={`${styles.sellerCart}`}>
        ...
        >
          ...
          {paymentMode != 'UPI' ? <input type="submit" value={'Place order'} /> : null}
          {paymentMode === 'UPI' ? <a href={`upi://pay?pa=9494248739@paytm&amp;pn=Mr Gaddey Hemanth Chowdary&amp;am=${totalCost}&amp;mc=bdOMam96965720364044&amp;cu=INR;tr=${generateRandomString()};tn=pharmacy delivery payment`} className='text-blue-500'>Pay via UPI</a> : null}
        </form>
      </div>
    );
  };
